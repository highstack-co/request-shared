...
export declare type RequestStatus = "paid" | "open" | "pending" | "canceled" | "overpaid" | "waiting";
/** Formatted request */
...
export declare const addEthereumChain: (chain: string | number, library?: providers.Web3Provider | undefined) => Promise<any> | null;
